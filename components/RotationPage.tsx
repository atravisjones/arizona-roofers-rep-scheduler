...
const RotationPage: React.FC = () => {
    ...
    return (
        <div className="h-full flex flex-col gap-3 min-h-0">
            {/* On a card, not on the page. The falls theme's body is a grey-to-orange
                gradient, and muted text sits on it at roughly 1.5:1 — the explainer
                line was effectively invisible. Every other block here is already a
                cream surface; the header was the one that was not. */}
            <div className="flex-shrink-0 flex items-center justify-between gap-3 flex-wrap bg-bg-primary border border-border-primary rounded-lg px-3 py-2">
                <div className="min-w-0">
                    ...
                    <div className="text-[11px] text-text-tertiary">
                        ...
                        booked to go counts as having taken their turn. <span className="text-text-tertiary">
