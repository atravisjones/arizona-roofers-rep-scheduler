...
const TAG_CLASSES: Record<string, string> = {
    ...
    'Spanish Speaker': 'bg-tag-blue-bg text-tag-blue-text border-tag-blue-border',
    'Ladder Pull': 'bg-tag-green-bg text-tag-green-text border-tag-green-border',
    '2 Story Ladder': 'bg-tag-red-bg text-tag-red-text border-tag-red-border',
